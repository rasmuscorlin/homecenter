...
-- Good morning scene
luaDaySchedule:add(getAlarm("alarmTime1"),"43", "" , "startScene", {getAlarm("alarmDays1")}, false);

-- Good morning end/reset
luaDaySchedule:add("10:00","45", "" , "startScene", {"All"}, false);

-- Auto disarm alarm (if armed by good night scene)
luaDaySchedule:add("06:00","67", "" , "startScene", {"All"}, false);
